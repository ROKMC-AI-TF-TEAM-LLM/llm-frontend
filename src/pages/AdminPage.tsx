...
export default function AdminPage() {
  ...
  return (
    <div className="min-h-screen bg-surface-subtle p-8">
      ...
      <h1 className="text-2xl font-bold text-text-primary mb-4">관리자 - 회원 관리</h1>
        ...
        <table className="w-full table-fixed bg-surface rounded-xl border border-surface-border shadow-sm text-sm">
          <thead>
            <tr className="border-b border-surface-border text-left text-text-muted">
              <th className="px-5 py-3 w-[13%]">이름</th>
              <th className="px-5 py-3 w-[30%]">이메일</th>
              <th className="px-5 py-3 w-[18%]">사용자 ID</th>
              <th className="px-5 py-3 w-[13%]">상태</th>
              <th className="px-5 py-3 w-[16%]">가입일</th>
              <th className="px-5 py-3 w-[10%]">처리</th>
            </tr>
          </thead>
          <tbody>
