    ...
    >
      ...
      <section data-guide-section className="relative px-[6vw] min-h-[calc(100vh-73px)] flex items-center overflow-hidden">
        <div className="absolute right-[4%] top-[14%] w-[340px] h-[340px] opacity-90 pointer-events-none animate-[marsFloat_8s_ease-in-out_infinite]">
          <div className="absolute -inset-[14%] rounded-full border-[1.5px] border-[rgba(228,0,43,0.16)] animate-[marsSpin_28s_linear_infinite]">
            <div className="absolute -left-1 top-[48%] w-[9px] h-[9px] rounded-full bg-brand shadow-[0_0_12px_3px_rgba(228,0,43,0.5)]" />
          </div>
          <div className="absolute -inset-[24%] rounded-full border-[1.5px] border-[rgba(228,0,43,0.16)] animate-[marsSpin_40s_linear_infinite]">
            <div className="absolute -left-1 top-[48%] w-[9px] h-[9px] rounded-full bg-brand shadow-[0_0_12px_3px_rgba(228,0,43,0.5)]" />
          </div>
      ...
      <section id="smart" data-guide-section className="px-[6vw] min-h-screen flex items-center py-16 scroll-mt-[66px]">
        <div className="w-full max-w-[960px] mx-auto">
          ...
          <Reveal delay={120}><p className="text-center mx-auto mb-13 max-w-[600px] font-semibold text-[17px] leading-[1.7] text-[#6a6a72]">단순히 그럴듯한 답을 내놓는 대신, 규정에 근거해 정직하게 답하도록 설계했습니다.</p></Reveal>
      ...
      <section id="tips" data-guide-section className="px-[6vw] min-h-screen flex items-center py-16 scroll-mt-[66px]">
        <div className="w-full max-w-[820px] mx-auto">
          ...
          <Reveal delay={120}><p className="text-center mx-auto mb-12 font-semibold max-w-[560px] text-[17px] leading-[1.7] text-[#6a6a72]">같은 질문도 조금만 다듬으면 훨씬 정확한 근거를 찾을 수 있습니다.</p></Reveal>
      ...
      <section id="faq" data-guide-section className="px-[6vw] min-h-screen flex items-center py-16 scroll-mt-[66px]">
        <div className="w-full max-w-[760px] mx-auto">
          ...
          <Reveal delay={120}><p className="text-center mx-auto mb-12 max-w-[560px] font-semibold text-[17px] leading-[1.7] text-[#6a6a72]">MARS를 쓰기 전 궁금해할 만한 것들을 모았습니다.</p></Reveal>
      ...
      <section data-guide-section className="relative px-[6vw] min-h-screen flex flex-col items-center justify-center text-center overflow-hidden">
        <Reveal className="relative z-[2]">
          ...
          <p className="mx-auto max-w-[460px] text-[17px] font-semibold text-text-secondary leading-relaxed">해병대의 모든 규정을, 대화 한 번으로.<br />MARS가 장병 여러분과 함께합니다.</p>
