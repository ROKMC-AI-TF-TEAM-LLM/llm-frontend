...
export default function SidebarFooter({ isOpen, user }: SidebarFooterProps) {
  ...
  return (
    <div className={`border-t border-surface-border py-4 flex items-center gap-2 ${isOpen ? "px-4" : "justify-center"}`}>
      <button className={`flex items-center gap-3 hover:bg-brand-subtle rounded-lg p-1 transition-colors ${isOpen ? "flex-1" : ""}`}>
