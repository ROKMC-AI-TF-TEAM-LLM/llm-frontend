...
const LoginCard = () => {
  ...
  return (
    <div className="card flex w-200 min-h-105 overflow-hidden">

      <div className="flex w-1/2 flex-col items-center justify-center gap-4 border-r border-surface-border px-12 py-12">

        <div className="w-[7.1vw] max-w-20 h-[7.1vw] max-h-20 rounded-full border --color-brand-dark: #8b0000;" />
      ...
      <div className="flex flex-col items-center justify-center gap-4 px-12 py-12 w-1/2">
        ...
        <h2 className="text-xl font-bold text-text-primary text-[22px]!">플랫폼 접속</h2>
        ...
        <button 
          className="btn-primary w-full h-[9vh] max-h-14 rounded-[20px]! text-[20px]!" 
